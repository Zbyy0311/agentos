...
/** Child-process-free Kimi JSONL parser shared by legacy and P3 adapters. */
export class KimiJsonParser implements CliEventParser {
...
export function createKimiJsonParser(): CliEventParser {
