...
export default function WorkspacePage() {
  ...
  return <div ref={layoutRef} data-signal-workspace data-workspace-layout className="signal-workspace app-shell flex h-screen min-w-0 overflow-hidden">
    ...
    {inspectorCollapsed && <button type="button" className="inspector-expand-strip" aria-label="展开执行状态面板" title="展开执行状态面板" onClick={() => setInspectorCollapsed(false)}><span aria-hidden="true">◀</span><span className="inspector-expand-strip-label">执行状态</span></button>}
