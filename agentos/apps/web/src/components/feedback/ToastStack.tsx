...
export function ToastStack({ toasts, onDismiss }: ToastStackProps) {
  ...
  return <div ref={glassRef} className={`pointer-events-none fixed bottom-6 right-6 ${uiLayerClass('toast')} flex w-[min(24rem,calc(100vw-2rem))] flex-col gap-2`} data-toast-stack>
