...
export function DiffBlock({ content }: { content: string }) {
  ...
  return <div className="markdown-code-block max-w-full overflow-hidden rounded-xl border ui-border">
    ...
    <pre className={`${wrapped ? 'whitespace-pre-wrap break-words' : 'overflow-x-auto whitespace-pre'} min-w-0 max-w-full bg-[var(--app-bg)] p-3 font-mono text-xs leading-5`} aria-label="代码差异">
