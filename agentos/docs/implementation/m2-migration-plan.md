...
| M2.6 | OWNER DECISIONS APPROVED — PENDING PLAN REVIEW; implementation not started | Branch `runtime/m2-6-idempotency-concurrency`; OD-1–OD-20 APPROVED 2026-07-28 (planning review BLOCKER 0 / HIGH 0 / MEDIUM 4 / LOW 1, all resolved); see `docs/implementation/milestones/M2.6-current-state-audit.md`, `M2.6-owner-decisions.md`, `M2.6-idempotency-concurrency-plan.md`; no production code, test, migration, or shared type change authorized; M2.7/M2.8 not started |
