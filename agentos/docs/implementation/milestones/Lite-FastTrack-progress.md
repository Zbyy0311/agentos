...
| Direct Conversation UX | **PARTIAL (forward routes + reply stream IN PR #110; client foundation IN the next PR)** | PR #110, #111; `conversationRuntime.ts`, `ConversationTurnDriver.ts`, `directConversation*.ts` |
