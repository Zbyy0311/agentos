...
| M2.6 | ✅ OWNER DECISIONS APPROVED — PENDING PLAN REVIEW; implementation not started (branch `runtime/m2-6-idempotency-concurrency`; OD-1–OD-20 APPROVED 2026-07-28, planning review BLOCKER 0 / HIGH 0 / MEDIUM 4 / LOW 1 all resolved; historical M2.6 draft `v008-idempotency-records.sql` is stale — registry tail is 001–009, Migration 010 exact schema frozen in OD-18; see `M2.6-current-state-audit.md`, `M2.6-owner-decisions.md`, `M2.6-idempotency-concurrency-plan.md`; no production code, test, migration, or shared type change authorized) |
