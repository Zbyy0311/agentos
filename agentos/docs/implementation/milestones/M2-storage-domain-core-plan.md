...
| 4 | **No version/concurrency** | HIGH | No optimistic concurrency on mutable aggregates; race risk remains |
...
| M2.7 | v1 Compatibility Read and Data Migration — OWNER DECISIONS APPROVED; PLAN CONTRACT REMEDIATION 3 COMPLETE; IMPLEMENTATION NOT AUTHORIZED; PENDING GITHUB SECONDARY CONFIRMATION | Medium | Medium | M2.3, M2.4 | `runtime/m2-7-v1-compatibility-migration` |
